...
window.rangy = function () {
    ...
    function i(a, b, c) {
        ...
        } else for (d = H.createIterator(d); e = d.next();)if (!1 === b(e))return c.stop = !0, void 0
    }
    ...
    a.commands.formatBlock = {
        exec: function (i, j, k, l, m) {
            ...
            if (p)i.selection.executeAndRestoreSimple(function () {
                ...
                if ((null === k || a.lang.array(h).contains(k)) && (n = i.selection.getSelectedNode(), p = g.getParentElement(n, {nodeName: h})))return i.selection.executeAndRestoreSimple(function () {
    ...
    var a = function () {
        ...
        function d(a) {
            a.registerHelper("helperMissing", function (a) {
                ...
                if (m(a) && (a = a.call(this)), b.data && (c = q(b.data)), a && "object" == typeof a)if (l(a))for (var h = a.length; h > f; f++)c && (c.index = f, c.first = 0 === f, c.last = f === a.length - 1), g += d(a[f], {data: c}); else for (var i in a)a.hasOwnProperty(i) && (c && (c.key = i), g += d(a[i], {data: c}), f++);
        ...
        function e(a, b) {
            ...
            c = b.compile ? function (a, c, d, e, f, g) {
                ...
                if (i)return i;
                var j = {helpers: e, partials: f, data: g};
                return f[c] = b.compile(a, {data: void 0 !== g}, b), f[c](d, j)
            } : function (a, b) {
            ...
            var e = {
                ...
                }, programWithDepth: f, noop: i, compilerInfo: null
            };
            return function (c, f) {
                f = f || {};
...
this.wysihtml5 = this.wysihtml5 || {}, this.wysihtml5.tpl = this.wysihtml5.tpl || {}, this.wysihtml5.tpl.color = Handlebars.template(function (a, b, c, d, e) {
    ...
    var c = function (a, c, d) {
        return b.tpl[a]({locale: c, options: d})
    }, d = function (c, d) {
        this.el = c;
        var e = d || f;
    ...
    d.prototype = {
        constructor: d, createEditor: function (c) {
            ...
            if (c && c.events)for (var e in c.events)d.on(e, c.events[e]);
            return d
    ...
    a.fn.wysihtml5.locale.en = a.fn.wysihtml5.locale["en-US"] = {
        ...
        emphasis: {bold: "Bold", italic: "Italic", underline: "Underline"},
