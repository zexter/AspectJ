...
<%
  ...
  if(id == null){
    response.sendRedirect("/Riders.jsp");
    return;
  }
  RiderDetails riderDetails = riderDetailsDAO.getRiderDetails(id);
              ...
              <div class="box-body">
                <div class="row">
                  <div class="box box-primary">
                    ...
                    <form role="form" method="post" action="/UpdateRider" name="uprider" id ="uprider">
                      <div class="col-lg-12">
                        <div class="col-lg-6">
                          <label for="name">Name</label>
                          <input type="text" class="form-control fa-asterisk" id="name" name="name"
                                 value="<%=riderDetails.getFullName()%>" required="required">
                          <%
                            if(riderDetails.getSex()==1){
                          %>
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="optionGender" id="optionFemale2" value="1"
                                     >
                              Female
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" name="optionGender" id="optionMale2"
                                     value="2" checked>
                              Male
                            </label>
                          </div>
                          ...
                          <input type="text" class="form-control fa-asterisk datepicker" id="birthdate"
                                 name="birthdate" value="<%=riderDetails.getDOB()%>" required/>

                          <label for="nic">NIC</label>
                          <input type="text" class="form-control" id="nic" name="nic"
                                 pattern="^\d[0-9]{8}[xXvV]$" title="Enter your 9 digits and V or X"
                                 value="<%=riderDetails.getNic()%>" required />

                          <label for="joindate">Date Joined</label>
                          <input type="text" class="form-control fa-asterisk datepicker" id="joindate"
                                 name="joindate" value="<%=riderDetails.getDateOfJoin()%>" required/>

                          <%
                            if(riderDetails.getMarStatus()==1){
                          %>
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="optionMarital" id="optionMarried2" value="1"
                                     checked>
                              Married
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" name="optionMarital" id="optionSingle2"
                                     value="2">
                              Single
                            </label>
                          </div>
